...
class Server{
    ...
    private:
        ...
        uint8_t processed_ack_message_[protocol::ACK_MESSAGE_LENGTH];
        uint8_t delivered_ack_message_[protocol::ACK_MESSAGE_LENGTH];
        uint8_t request_communication_message_[protocol::REQUEST_MESSAGE_LENGTH];
};
